...
FULL_PATH = r'C:/Users/praveen.thangadancha/Documents/personal Docs/probability'
DIR_NAME = 'probability'
# Or simply
...
def main():
    ...
    for folder_dir in upload_folders:
        var = os.path.join(full_path.split('/')[0:-1]) + os.path.sep
